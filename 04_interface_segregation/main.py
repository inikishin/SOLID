"""Методы подклассов не должны реализовывать методы, которые им не нужны. Для
этого можно создавать структуру подклассов, которые требуют имплементации,
только необходимых методов.

Это можно реализовать структурой подклассов, или через конструкторы классов.
"""
